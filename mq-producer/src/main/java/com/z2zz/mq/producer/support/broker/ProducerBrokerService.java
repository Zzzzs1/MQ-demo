...
import com.z2zz.mq.producer.core.MqProducer;
import com.z2zz.mq.producer.dto.SendBatchResult;
import com.z2zz.mq.producer.dto.SendResult;
import com.z2zz.mq.producer.handler.MqProducerHandler;
...
public class ProducerBrokerService implements IProducerBrokerService {
    ...
    public SendResult send(final MqMessage mqMessage) {
        ...
        return Retryer.<SendResult>newInstance()
                .maxAttempt(maxAttempt).callable(new Callable<SendResult>() {
                    @Override
